...
import { calculatorActionTypes, store } from '../store/calculator/calculatorReducer';
...
const Calculator = () => {
 ...
 const dispatch = useDispatch()
  ...
  const addHandler = () => {
    //store.dispatch({type: calculatorActionTypes.ADD, payload: 5}) debeile dispatch koldonobuz
